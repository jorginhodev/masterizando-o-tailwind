        ...
        >
          <div className="grid-cols-form grid gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <InputRoot>
                <InputControl defaultValue="Ramos" />
              </InputRoot>
            </div>
          </div>
          ...
          <div className="grid-cols-form grid gap-3 pt-5">
            ...
            <div className="flex items-start gap-5">
              ...
              <label
                htmlFor="photo"
                className="hover:bg-violet-25 group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm transition duration-150 ease-in-out hover:border-violet-200 hover:text-violet-500"
              >
